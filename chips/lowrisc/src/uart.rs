...
impl Uart<'a> {
    ...
    fn enable_tx_interrupt(&self) {
        ...
        regs.intr_enable
            .write(intr::tx_watermark.val(1 as u32) + intr::tx_overflow.val(1 as u32));
    }
    ...
    fn enable_rx_interrupt(&self) {
        ...
        regs.intr_enable
            .write(intr::rx_watermark.val(1 as u32) + intr::rx_overflow.val(1 as u32));
    ...
    pub fn handle_interrupt(&self) {
        ...
        self.tx_client.map(|client| {
            self.buffer.take().map(|buffer| {
                client.transmitted_buffer(buffer, 1, ReturnCode::SUCCESS);
            });
        });
    }
